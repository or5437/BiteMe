...
/**
 * Class that Describes screen of choose private customer to register by BM
 * manager
 * 
 * @author Tal Derai
 *
 */
public class SearchIdBeforeRegisterPrivateController implements Initializable {
	/**
	...
	/**
	 * Upload screen of Search Id Before Register Private Customer
	 * 
	 * @param primaryStage
	 * @throws Exception
	 */
	public void start(Stage primaryStage) throws Exception {
		Parent root = FXMLLoader.load(getClass().getResource("/controllers/SearchIdBeforeRegisterPrivatePage.fxml"));
	...
	/**
	 * When clicked, on next button, upload screen registration private customer
	 * 
	 * @param event
	 * @throws IOException
	 */
	...
	void Next(ActionEvent event) throws IOException {
		...
		Stage primaryStage = new Stage();
		RegisterNewPrivateCustomerController registerNewPrivateCustomer = new RegisterNewPrivateCustomerController();
		registerNewPrivateCustomer.start(primaryStage);
	}
